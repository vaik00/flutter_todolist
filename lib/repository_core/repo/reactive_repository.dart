...
class ReactiveTodosRepositoryFlutter implements BaseReactiveTodosRepository {
  final BaseTodosRepository _repository;
  final BehaviorSubject<List<TodoEntity>> _subject;
  bool _loaded = false;

  ReactiveTodosRepositoryFlutter({
    @required BaseTodosRepository repository,
